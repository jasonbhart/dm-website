...
outcome:
  headline: "Cut through the noise and build analytics you can trust"
  points:
...
projects:
  ...
  items:
    - name: "Marketing Analytics & Attribution"
      description: "Understand which campaigns and channels actually drive results"
    - name: "Revenue Operations Metrics"
